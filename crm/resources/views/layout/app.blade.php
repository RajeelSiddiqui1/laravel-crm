                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="dropdown-item">
                                    ...
                                    <a href="{{ route('project_manager.logout') }}">Logout</a>
                                </li>
                            </ul>
                        </li>
        @endif
                ...
                <ul class="sidebar-menu do-nicescrol">
                    ...
                    <li>
                        <a href="{{url('/project-owner/project-manager')}}">
                            <i class="zmdi zmdi-view-dashboard"></i> <span>Project Managers</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{url('/project-owner/team-leads')}}">
                            <i class="zmdi zmdi-invert-colors"></i> <span>Team Leads</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{url('/project-owner/departments')}}">
                            <i class="zmdi zmdi-invert-colors"></i> <span>Departments</span>
                        </a>
                    </li>
                    ...
                    <ul class="navbar-nav align-items-center right-nav-link">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown"
                                href="#">
                                <span class="user-profile">
                                    <img src="{{ Auth::guard('project_owner')->user()->image
                                        ? asset('images/project_owner/' . Auth::guard('project_owner')->user()->image)
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                ...
                                <li class="dropdown-item">
                                    <i class="icon-power mr-2"></i>
                                    <a href="{{ route('project_owner.logout') }}">Logout</a>
                                </li>
                            </ul>
                        </li>
        @endif
