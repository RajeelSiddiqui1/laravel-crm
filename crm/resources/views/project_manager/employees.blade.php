    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-end">
                <a href="{{ route('project_manager.create_employee_view') }}" class="btn btn-primary mb-4">Create Employee</a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="attachment-item text-center">
                                    <a href="{{ $em->image ? asset('images/employees/' . $em->image) : 'https://avatar.iran.liara.run/public/28' }}"
                                       target="_blank">
