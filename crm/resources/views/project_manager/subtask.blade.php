    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        statusFilters.forEach(select => {
            select.addEventListener('change', () => {
                ...
                document.querySelectorAll(`.employee-group[data-employee="${employee}"] .subtask-row`).forEach(row => {
        ...
        function filterGroups() {
            groups.forEach(group => {
                ...
                group.style.display = (selectedEmployee === 'all' || selectedEmployee === emp) ? '' : 'none';
            });
        }
