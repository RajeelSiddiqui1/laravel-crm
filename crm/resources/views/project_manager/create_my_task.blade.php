        ...
        <div class="col-md-8 col-lg-6">
            <div class="card shadow rounded">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('project_manager.mytask_store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select name="department_id" id="department_id" class="form-control custom-select bg-dark text-white">
                        ...
                        <div class="form-group">
                            ...
                            <select name="team_lead_id" id="team_lead_id" class="form-control custom-select bg-dark text-white">
                                <option value="">Select Team Lead</option>
                                @foreach($team_leads as $lead)
                                    <option value="{{ $lead->id }}" {{ old('team_lead_id')==$lead->id ? 'selected' : '' }}>{{ $lead->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group" hidden>
                            ...
                            <select name="status" id="status" class="form-control custom-select bg-dark text-white">
