...
@section('styles')
    ...
    <style>
        ...
        .table td {
            ...
            /* Add border to maintain table structure visibility */
        }
    ...
    <div class="container mt-4">
        ...
        <div class="row">
            <div class="col-md-12 d-flex justify-content-end">
                <a href="{{ route('project_manager.owntask_create') }}" class="btn btn-primary mb-3">Create Task</a>
            </div>
        </div>
        <!-- T1 Accounts -->
                        ...
                        @forelse ($accountst1 as $account)
                            <tr class="align-middle text-center">
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('project_manager.mytask_delete', $account->id) }}" method="POST"
                        ...
                        @forelse ($accountst2 as $account)
                            ...
                            <tr class="align-middle text-center">
                                ...
                                <td>
                                    <a href="{{ route('project_manager.mytask_edit', $account->id) }}"
                                        class="btn btn-sm btn-warning">Edit</a>
                                    <form action="{{ route('project_manager.mytask_delete', $account->id) }}"
