                ...
                <div class="card-body p-4">
                    ...
                    <div class="attachment-container">
                        ...
                        @if (in_array($subtaskExt, ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                            ...
                            <a href="{{ $subtask->attachments }}" download
                                class="btn btn-outline-light btn-sm rounded-pill mt-2">
                    ...
                    <div class="col-12 mb-4">
                        <div class="card bg-glass shadow-lg border-0">
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="mb-2"><strong>Employee:</strong> {{ $pos->employee->name ?? 'N/A' }}
                                        </p>
                                        <p class="mb-2"><strong>Comment:</strong> {{ $pos->comment ?? 'N/A' }}</p>
                                        <p class="mb-2"><strong>Business:</strong> {{ $pos->business_name ?? 'N/A' }}</p>
                                        <p class="mb-2"><strong>Business Number:</strong>
                                            {{ $pos->business_number ?? 'N/A' }}</p>
                                        <p class="mb-2"><strong>Personal Number:</strong>
                                            {{ $pos->personal_number ?? 'N/A' }}</p>
                                        <p class="mb-2"><strong>Personal Email:</strong>
                                            {{ $pos->personal_email ?? 'N/A' }}</p>
                                        <p class="mb-2"><strong>Business Email:</strong>
                                            {{ $pos->business_email ?? 'N/A' }}</p>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-2"><strong>Debt:</strong> ${{ number_format($pos->debt ?? 0, 2) }}
                                        </p>
                                        <p class="mb-2"><strong>Credit:</strong>
                                            ${{ number_format($pos->credit ?? 0, 2) }}</p>
                                        <p class="mb-2"><strong>Rental:</strong>
                                            ${{ number_format($pos->rental ?? 0, 2) }}</p>
                                        <p class="mb-2"><strong>Business Type:</strong>
                                            {{ $pos->business_type ?? 'N/A' }}</p>
                                ...
                                @if ($pos->attachments)
                                    <div class="attachment-container mt-4">
                                        @php
                                            $posExt = strtolower(
                                                pathinfo(
                                                    parse_url($pos->attachments, PHP_URL_PATH),
                                                    PATHINFO_EXTENSION,
                                                ),
                                            );
                                        @endphp
                                        @if (in_array($posExt, ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                                            <a href="{{ $pos->attachments }}"
                                                data-lightbox="pos-attachment-{{ $pos->id }}">
                                                <img src="{{ $pos->attachments }}" alt="POS Attachment"
                                                    class="img-fluid rounded shadow-sm"
                                                    style="max-height: 200px; width: auto;">
                                            </a>
                                            <a href="{{ $pos->attachments }}" download
                                                class="btn btn-outline-light btn-sm rounded-pill mt-2">
                                                <i class="bi bi-download me-2"></i> Download Image
                                            </a>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card bg-glass shadow-lg border-0">
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p class="mb-2"><strong>Employee:</strong>
                                            {{ $account->employee->name ?? 'N/A' }}</p>
                                ...
                                @if ($account->attachments)
                                    <div class="attachment-container mt-4">
                                        @php
                                            $accountExt = strtolower(
                                                pathinfo(
                                                    parse_url($account->attachments, PHP_URL_PATH),
                                                    PATHINFO_EXTENSION,
                                                ),
                                            );
                                        @endphp
                                        @if (in_array($accountExt, ['jpg', 'jpeg', 'png', 'gif', 'webp']))
                                            <a href="{{ $account->attachments }}"
                                                data-lightbox="account-attachment-{{ $account->id }}">
                                                <img src="{{ $account->attachments }}" alt="Account Attachment"
                                                    class="img-fluid rounded shadow-sm"
                                                    style="max-height: 200px; width: auto;">
                                            </a>
                                            <a href="{{ $account->attachments }}" download
                                                class="btn btn-outline-light btn-sm rounded-pill mt-2">
                                                <i class="bi bi-download me-2"></i> Download Image
                                            </a>
                                        @elseif (in_array($accountExt, ['mp4', 'mov', 'avi', 'webm']))
                                            <div class="media-wrapper">
                                                <video controls class="w-100 rounded shadow-sm"
                                                    ...
                                                    <source src="{{ $account->attachments }}"
                                                        type="video/{{ $accountExt }}">
                                                </video>
                                                <a href="{{ $account->attachments }}" download
                                                    class="btn btn-outline-light btn-sm rounded-pill mt-2">
                                                    <i class="bi bi-download me-2"></i> Download Video
