                            ...
                            <form method="POST" action="{{ route('project_manager.mytask_update', $account->id) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="clientname" class="form-control text-white"
                                        value="{{ old('clientname', $account->clientname) }}">
                                </div>
                                ...
                                @if ($accountType === 'T2' || $accountType === 'HST')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="corpration_number" class="form-control text-white"
                                            value="{{ old('corpration_number', $account->corporation_number ) }}">
                                    </div>
                                    <div class="form-group">
                                        <label class="text-white">Corporation Name</label>
                                        <input type="text" name="corpration_name" class="form-control text-white"
                                            value="{{ old('corpration_name', $account->corporation_name) }}">
                                    </div>
                                    <div class="form-group">
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (departmentSelect && teamLeadSelect) {
                        departmentSelect.addEventListener('change', function() {
                            ...
                            const options = teamLeadSelect.querySelectorAll('option[data-department]');
