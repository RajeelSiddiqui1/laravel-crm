...
<div class="container py-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h4 class="fw-bold text-dark">Chat with {{ $teamlead->name }}</h4>
        ...
        <div class="card-body p-4">
            @foreach ($messages as $msg)
                @php
                    ...
                    $attachments = $msg->attachments ?? null; // Single attachments
                @endphp
    ...
    <!-- Message Input Form -->
    <form action="{{ route('employee.message.send') }}" method="POST" enctype="multipart/form-data" class="mt-3" id="message-form">
        @csrf
