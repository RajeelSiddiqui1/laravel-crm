                    ...
                    <tbody>
                        @forelse($posResults as $index => $pos)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('employee.shared.pos.detail', $pos->id) }}"
                                        class="btn btn-sm btn-success">Show More</a>
                                </td>

                                <td>
                                    <a href="{{ route('employee.task_info.view', $pos->shared_task_id) }}"
                    ...
                    <tbody>
                        @forelse($accountResults as $index => $account)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('employee.shared.account.detail', $account->id) }}"
                                        class="btn btn-sm btn-success">Show More</a>
                                </td>

                                <td>
                                    <a href="{{ route('employee.task_info.view', $account->shared_task_id) }}"
                                        class="btn btn-sm btn-primary">Create</a>
