                ...
                <tbody>
                    @forelse($posResults as $index => $pos)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('visitor.lead_info.view', $pos->shared_task_id) }}"
                                    class="btn btn-sm btn-primary">Add Lead Info</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                ...
                <tbody>
                    @forelse($accountResults as $index => $account)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('visitor.lead_info.view', $account->shared_task_id) }}"
                                    class="btn btn-sm btn-primary">Add Lead Info</a>
                            </td>
                        </tr>
                    @empty
