...
<body>
    <div class="container">
        ...
        <p>
            You have been assigned a new <strong>shared task</strong> by 
        ...
        <p style="margin-top:20px;">
            Please review this task and take the necessary action.
        </p>

        <div style="text-align:center;">
            <a href="{{ url('/operation/shared-tasks') }}" class="btn">View Task</a>
        </div>
